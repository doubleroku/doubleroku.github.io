...
<img src="https://cdn.mathpix.com/snip/images/dy38P0uhVFINxSAR5AvW8gQxviPTEfNS4FFFX7xseOY.original.fullsize.png"/>：输入公钥$PK$，验证密钥$VK$，密文$C$，对于集合$S \subset{1, \ldots, n}$，且有$t=\|S\|$，$S$中每一个参与者输入各自的解密份额$\left\{\mu_{i}\}_{{i} \in {S}\right}$。
