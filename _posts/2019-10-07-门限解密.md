...
$\text { Combine }\left(P K, \mathbf{V K}, C,\left\{\mu_{i}\right\}\_{i \in S}\right)$：输入公钥$PK$，验证密钥$VK$，密文$C$，对于集合$S \subset{1, \ldots, n}$，且有$t=\|S\|$，$S$中每一个参与者输入各自的解密份额$\left\{\mu_{i}\}_{{i} \in {S}\right}$。
